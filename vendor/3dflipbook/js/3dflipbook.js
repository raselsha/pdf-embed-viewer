!(function (modules) {
    ...
    (__webpack_require__.m = modules),
        ...
        __webpack_require__((__webpack_require__.s = 77));
})([
    ...
    function (module, exports, __webpack_require__) {
        ...
        var BaseMathUtils = (function () {
            ...
            return (
                ...
                (BaseMathUtils.pdfJsTransform = function (t, e) {
                    return [
                        t[0] * e[0] + t[2] * e[1],
                        t[1] * e[0] + t[3] * e[1],
                        t[0] * e[2] + t[2] * e[3],
                ...
                (BaseMathUtils.mapl2L = function (ls, len, n, f) {
                    for (
                        ...
                        Math.abs(L - d) < Math.abs(L - d - ls[i + 1]) && (f(i, L), (L += dL));
                ...
                (BaseMathUtils.computeSquare = function (ps) {
                    for (var a = [], p = 0, i = 0; i < ps.length; ++i)
                        a.push(BaseMathUtils.v2dist(ps[i], ps[(i + 1) % ps.length])), (p += 0.5 * a[i]);
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _libs = __webpack_require__(0),
            _BaseMathUtils2 = __webpack_require__(3),
                ...
                return (
                    ...
                    (MathUtils.getLinearIndeces = function (spline, n) {
                        ...
                        for (
                            ...
                            Math.abs(L - _d) < Math.abs(L - _d - ls[_i + 1]) && (res.push(2e-4 * _i), (L += dl));
                        return res;
                    }),
                ...
                return (
                    ...
                    (ImageBase.prototype.setRenderPause = function (renderPause) {
                        (this.renderPause = renderPause),
                            !renderPause && this.continueRender && (this.continueRender(), delete this.continueRender);
                    }),
                        ...
                        switch (e.type) {
                            ...
                            case "mousemove":
                                !this.test(this.mHovObject, object) &&
                                    this.mHovObject &&
                                    (this.notify(this.mHovObject, e, "mouseout"), (this.mHovObject = void 0)),
                                    !this.mHovObject &&
                                        object &&
                                        (this.notify(object, e, "mouseover"), (this.mHovObject = object)),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _Cache = __webpack_require__(14),
            ...
            _BlankImage = __webpack_require__(47),
            _BlankImage2 = _interopRequireDefault(_BlankImage),
            _StaticImage = __webpack_require__(63),
            _StaticImage2 = _interopRequireDefault(_StaticImage),
            _PdfImage = __webpack_require__(61),
            _PdfImage2 = _interopRequireDefault(_PdfImage),
            _InteractiveImage = __webpack_require__(55),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _extends =
            ...
            _BaseMathUtils = __webpack_require__(3),
                ...
                return (
                    ...
                    (SheetBlock.prototype.getProps = function () {
                        return _extends({}, this.p.page, {
                            width: this.p.page.width - (this.reducedWidth ? 0.001 * this.p.page.width : 0),
                    ...
                    (SheetBlock.prototype.set = function (angle) {
                        var state = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.state,
                            height =
                                arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.corner.height,
                        ...
                        var inAngle = this.angle > PI / 2 ? PI - this.angle : this.angle,
                            ...
                            _getPointsAtAngleAndH = this.getPointsAtAngleAndHs(points, inAngle, hAngle, [
                                hl / props.width,
                                hr / props.width,
                            ]),
                        ...
                        if (
                            ...
                            this.materialsCallback && this.materials)
                        )
                            for (
                                var _iterator5 = this.materials,
                    ...
                    (SheetBlock.prototype.setPoints = function (left, right, offset) {
                        for (
                            var _this2 = this, p = this.getProps(), i = 0, ys = [right, left], y = 0;
                        ...
                        if (
                            (i !== this.geometry.vertices.length && console.warn("setPoints: bad mapping!"),
                        ...
                        if (this.corner.use && Math.abs(this.corner.height) > 0.001) {
                            ...
                            for (
                                var _iterator6 = this.corner.points,
                        ...
                        for (
                            ...
                            if (_isArray7) {
                                ...
                                if (((_i10 = _iterator7.next()), _i10.done)) break;
                                _ref7 = _i10.value;
                            }
                            var m = _ref7;
                    ...
                    (SheetBlock.prototype.interpolate = function (x, y, xi) {
                        ...
                        for (var spline = this.aSplines[x.length], _i11 = 0; _i11 < x.length; ++_i11)
                    ...
                    (SheetBlock.prototype.loadPoints = function () {
                        for (
                            var x = [], y = [], _arr = [0, 0.2877, 0.6347, 0.8174, 1], _i12 = 0;
                            _i12 < _arr.length;
                            _i12++
                        ) {
                            var r = _arr[_i12];
        ...
        function props() {
            var style = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "volume",
                def = {
                    ...
                    cover: { side: "transparent", binderTexture: "", depth: 3e-4, padding: 0, mass: 0.001 },
                ...
                styles = {
                    ...
                    flat: _extends({}, def, {
                        lighting: "ambient",
                        sheet: _extends({}, def.sheet, { wave: 0.05, side: "transparent", shape: 1 }),
                        cover: _extends({}, def.cover, { depth: 2e-5 }),
                        page: _extends({}, def.page, { depth: 1e-5 }),
                    }),
                    "volume-paddings": _extends({}, def, { cover: _extends({}, def.cover, { padding: 0.0025 }) }),
                };
            return (
                ...
                function renderObject(object, camera, cameraCSSMatrix) {
                    if (object instanceof _libs.THREE.CSS3DObject) {
                        ...
                        (void 0 !== cachedStyle && cachedStyle === style) ||
                            ...
                            isIE &&
                                (cache.objects[object.id].distanceToCameraSquared = getDistanceToSquared(
                                    camera,
                                    object
                                ))),
            ...
            CSSLayer = (function (_CSS3DObject) {
                ...
                return (
                    ...
                    (CSSLayer.prototype.setData = function setData() {
                        ...
                        this.clearInternals(),
                            (this.css = (0, _libs.$)('<style type="text/css">' + css + "</style>").appendTo(
                                this.jContainer
                            )),
        ...
        var Cache = (function () {
            ...
            return (
                ...
                (Cache.prototype.remove = function (k) {
                    ...
                    return (
                        (v.locked && v.locked(k)) ||
                            ((this.size -= this.sizeof(v)), v.dispose && v.dispose(), this.os.delete(k), (res = !0)),
                        res
                    );
                }),
    ...
    function (module, exports, __webpack_require__) {
        ...
        exports.__esModule = !0;
        var _libs = __webpack_require__(0),
            _FullScreen2 = __webpack_require__(54),
            ...
            Pdf = (function () {
                function Pdf(src, loadingProgress, openOptions) {
                    ...
                    _classCallCheck(this, Pdf),
                        ...
                        (this.pdfJsWorker =
                            PATHS.pdfJsLib && Pdf.isStable() ? PATHS.stablePdfJsWorker : PATHS.pdfJsWorker),
                        (PDFJS
                            ? Promise.resolve(PDFJS)
                            : new Promise(function (resolve) {
                                  (PATHS.pdfJsLib
                                      ? new Promise(function (resolveFetch, rejectFetch) {
                                            _libs.$.get(
                                                Pdf.isStable() ? PATHS.stablePdfJsLib : PATHS.pdfJsLib,
                                                function (pdfJsLibCode) {
                                                    eval(pdfJsLibCode), resolve(window.pdfjsLib);
                                                }
                                            ).fail(rejectFetch);
                                        })
                                      : Promise.resolve(_libs.PDFJS)
                                  )
                                      .then(resolve)
                                      .catch(function (e) {
                                          var error = { name: "pdfJsLib", message: e.statusText };
                                          console.error(error), _this.errorHandler && _this.errorHandler(error);
                                      });
                              })
                        ).then(function (pdfJs) {
                            PDFJS ||
                ...
                return (
                                ...
                                this.doubledPages
                                    ? (done = (
                                          2 === handler.numPages
                                              ...
                                              : handler.getPage(handler.numPages)
                                      ).then(function (pl) {
                                          var pls = Pdf.getPageSize(pl);
                                          return (
                                              (_this2.doubledLastPage =
                                                  p0s.width / p0s.height / (pls.width / pls.height) < 0.75),
                                              handler
                                          );
                                      }))
                                    : (this.doubledLastPage = !1);
                        } else this.doubledPages = this.doubledLastPage = !1;
                        for (
                    ...
                    (Pdf.prototype.getPageType = function (n) {
                        return !this.doubledPages || 0 === n || (n === this.getPagesNum() - 1 && !this.doubledLastPage)
                            ? "full"
                            : 1 & n
                              ? "left"
                              : "right";
                    ...
                    (Pdf.prototype.getPagesNum = function () {
                        return this.handler
                            ? this.doubledPages
                                ? 1 + 2 * (this.handler.numPages - (1 + !this.doubledLastPage)) + !this.doubledLastPage
                        ...
                        for (
                            ...
                            for (var p = _ref, found = !1, i = first; i < last && !found; ++i) {
                                ...
                                _BaseMathUtils2.default.isInsideConvPoly(tri, p) &&
                                    (res.push({ coefs: _BaseMathUtils2.default.computeInterpCoefs(tri, p), i: i }),
                                    (found = !0));
                            }
    ...
    function (module, exports, __webpack_require__) {
        ...
        ($.fn.FlipBook = function (options) {
            ...
            $(function () {
                for (var containers = $(".flip-book-container"), i = 0; i < containers.length; ++i) {
            ...
            Array.prototype.find ||
                Object.defineProperty(Array.prototype, "find", {
                    value: function (predicate) {
                        ...
                        for (
                            var value, list = Object(this), length = list.length >>> 0, thisArg = arguments[1], i = 0;
                            i < length;
                            i++
                        )
            ...
            Binder = (function () {
                function Binder(visual, p) {
                    ...
                    "" !== p.cover.binderTexture &&
                        ...
                        hidden || (backM.position.set(0.5 * (p.cover.depth - 0.001), 0, 0), this.back.add(backM)),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _extends =
            ...
            _CircleTarget = __webpack_require__(73),
            _CircleTarget2 = _interopRequireDefault(_CircleTarget),
            _YouTubeApi = __webpack_require__(72),
            ...
            Book = (function (_THREE$EventDispatche) {
                    ...
                    return (
                        (_this.cssFs = {
                            play: function (player) {
                                if (player.play)
                                    (player.fb3dNoPlay = !1),
                                        (player.play() || { catch: function () {} }).catch(function (e) {
                                            player.fb3dNoPlay ||
                ...
                return (
                    ...
                    (Book.prototype.init = function (visual, sheets, _pageCallback, props) {
                        var _this2 = this;
                        (this.args = { visual: visual, sheets: sheets, pageCallback: _pageCallback, props: props }),
                            (this.visual = visual),
                            (this.mouseController = !0),
                            (this.halfBookMode = props.halfBookMode || !1),
                            (this.p = _extends(
                                {},
                                this.prepareProps(
                                    _extends({}, props, {
                                        sheets: this.isHalfBookMode() ? Math.max(props.pages - 2, 0) : sheets,
                                    })
                                ),
                                {
                                    pageCallback: function (n) {
                                        return _this2.isHalfBookMode()
                                            ? n % 2 == 0
                                                ? _extends({}, _pageCallback(n / 2), { number: n / 2 })
                                                : { type: "blank" }
                                            : _pageCallback(n);
                                    },
                            ...
                            (this.userDirection = { lastTopPage: 0, direction: 1 }),
                            ...
                            (this.three = new _libs.THREE.Object3D()),
                            (this.binder = new _Binder2.default(
                                visual,
                                this.p,
                                this.getPages() < 3 || this.isHalfBookMode()
                            )),
                            this.three.add(this.binder.three);
                        var coverP = { left: this.p.cover, right: this.p.cover };
                        if (
                            ...
                            (this.leftCover = new _Cover2.default(
                                visual,
                                _extends({}, this.p, {
                                    cover: coverP.left,
                                    setTexture: this.setLeftCoverTexture.bind(this),
                                }),
                                Math.PI / 2,
                                "opened"
                            )),
                            ...
                            (this.rightCover = new _Cover2.default(
                                visual,
                                _extends({}, this.p, {
                                    cover: coverP.right,
                                    setTexture: this.setRightCoverTexture.bind(this),
                                }),
                                0,
                                "closed"
                            )),
                            ...
                            this.threeSheetBlocks.position.set(
                                0.5 * this.p.cover.depth - 0.5 * this.p.sheets * this.p.page.depth,
                                -0.5 * this.p.sheets * this.p.page.depth,
                                0
                            ),
                            (this.sheetBlocks = []),
                            this.p.sheets > 0 &&
                            ...
                            this.reducePagesWidth(!0),
                            this.isHalfBookMode())
                        ) {
                            var cover = this.p.rtl ? this.rightCover : this.leftCover;
                            (cover.three.castShadow = !1),
                                (cover.three.receiveShadow = !1),
                            ...
                            for (
                                ...
                                _ref.materialsCallback = function (block, m, angle, state) {
                                    var PI = Math.PI;
                                    "closed" === state
                                        ? (_this2.p.rtl ? angle <= PI / 2 : angle > PI / 2)
                                            ? ((m.opacity = 0), (m.transparent = !0))
                                            : ((m.opacity = 1),
                                              (m.transparent = !1),
                                              (block.three.castShadow = !0),
                                              (block.three.receiveShadow = !0))
                                        : ((block.three.castShadow = !1),
                                          (block.three.receiveShadow = !1),
                        ...
                        this.set(Math.PI / 2),
                            ...
                            (this.sheetPhysics = new _SheetPhysics2.default(
                                this.p.page.width / this.p.scale,
                                this.p.gravity,
                                this.p.page.cornerDeviation
                            )),
                            (this.binds = {
                            ...
                            (this.dragAngle = 0.05),
                            (this.tmp = { boxs: [new _libs.THREE.Box3(), new _libs.THREE.Box3()] }),
                            this.visual.addObject(this.three),
                            (this.tmpBox = new _libs.THREE.Box3()),
                            (this.bookShadowMaterial = new _libs.THREE.MeshPhongMaterial({
                                color: 0,
                                side: _libs.THREE.DoubleSide,
                                transparent: !0,
                            })),
                            (this.bookShadow = new _libs.THREE.Mesh(
                                new _libs.THREE.PlaneGeometry(1, 1).rotateX(-Math.PI / 2),
                                this.bookShadowMaterial
                            )),
                            ...
                            setTimeout(function () {
                                _this2.isProcessing() ||
                                    (_this2.notifyBeforeAnimation(), _this2.notifyAfterAnimation());
                            }, 100),
                            this.updateThree();
                    }),
                    (Book.prototype.reInit = function () {
                        var p = this.p,
                            r = {
                    ...
                    (Book.prototype.togleHalfBookMode = function () {
                        (this.args.props = _extends({}, this.args.props, { halfBookMode: !this.halfBookMode })),
                            this.reInit();
                    }),
                    ...
                    (Book.prototype.resolvePendingPlayers = function () {
                        for (
                            var _iterator2 = this.pendingPlayers,
                                _isArray2 = Array.isArray(_iterator2),
                                _i2 = 0,
                                _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();
                            ;
                    ...
                    (Book.prototype.setZoom = function (zoom, singlePage) {
                        (Math.abs(this.p.zoom - zoom) > 0.001 || singlePage !== this.p.singlePage) &&
                            ((this.p.zoom = zoom), (this.p.singlePage = singlePage), this.pageManager.refreshZoom());
                    }),
                    ...
                    (Book.prototype.isHalfBookMode = function () {
                    ...
                    (Book.prototype.getRealPages = function () {
                        return this.p.pages;
                    }),
                    ...
                    (Book.prototype.getPage = function () {
                        ...
                        if (this.angle === PI / 2 || this.angle === (3 * PI) / 2) {
                            for (
                                var _iterator5 = this.sheetBlocks,
                                    _isArray5 = Array.isArray(_iterator5),
                                    _i5 = 0,
                                    _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();
                                ;
                    ...
                    (Book.prototype.getClosedBlockAngle = function (angle) {
                        ...
                        if (this.leftCover.physicId) {
                            ...
                            try {
                                test = Math.abs(
                                    this.sheetPhysics.getParametr(this.leftCover.physicId, "angle") - angle
                                );
                            } catch (e) {
                                test = 0;
                            }
                            ...
                            try {
                                _test = Math.abs(
                                    this.sheetPhysics.getParametr(this.rightCover.physicId, "angle") - angle
                                );
                            } catch (e) {
                                _test = 0;
                            }
                    ...
                    (Book.prototype.flipLeft = function () {
                        var _this3 = this,
                            ...
                            progressClb =
                                arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.p.flipProgressClb;
                                    ...
                                    : left && "closed" === left.state && left.angle > PI / 2
                                      ...
                                      : (this.angle !== PI / 2 && this.angle !== (3 * PI) / 2) ||
                                        (res = this.connectPhysics(
                                            ...
                                            function (angle, height) {
                                                return _this3.set(0 === angle ? 0 : 2 * PI - angle / 2, 0);
                                            },
                                            progressClb
                                        ));
                            }
                                    ...
                                    : right && "closed" === right.state && right.angle <= PI / 2
                                      ? ((block =
                                        ...
                                        (res = this.connectPhysics(
                                            ...
                                            function (angle, height) {
                                                return block.set(
                                                    _this4.getClosedBlockAngle(angle),
                                                    "opened",
                                                    height,
                                                    block.p.first,
                                                    block.p.last,
                                                    _this4.flipDirection
                                                );
                                            },
                                            Book.finishAnimationClb.bind({ book: this, block: block }),
                                            progressClb
                                        ...
                                        (res = this.connectPhysics(
                                            ...
                                            function (angle, height) {
                                                _this4.set(PI / 2 + angle / 2, height),
                                                    angle < PI / 2 && _this4.setSheetBlocks(PI / 2 + 1e-7, "closed");
                                            },
                                            function (angle, height) {
                            ...
                            if ("mouseover" === e.type) {
                                if (this.hoverInfo && void 0 !== this.hoverInfo.pendings) ++this.hoverInfo.pendings;
                                    ...
                                    if (
                                        ...
                                        (!nextBlock ||
                                            !nextBlock.physicId ||
                                            (nextBlock.angle > 0.02 && nextBlock.angle < Math.PI - 0.02)) &&
                                    ...
                                    res.then(function (block) {
                                        if (
                                            (_this5.hoverInfo &&
                                                _this5.hoverInfo.pendings < 1 &&
                                                ((block = void 0), delete _this5.hoverInfo),
                                            block)
                                        ) {
                                            _this5.pageManager.turnOffEvents();
                                            var p = block.getProps();
                                            (block.force = _this5.sheetPhysics.getTargetForceClb(
                                                ...
                                                _this5.sheetPhysics.setParametr(
                                                    block.physicId,
                                                    "angle",
                                                    i ? Math.PI - 0.01 : 0.01
                                                ),
                                                (_this5.hoverInfo = { n: n, block: block }),
                                                _this5.update(1 / 30);
                                        }
                                    });
                                }
                    ...
                    (Book.prototype.reducePagesWidth = function (reduceWidth) {
                        for (
                            var _iterator9 = this.sheetBlocks,
                    ...
                    (Book.prototype.connectPhysics = function (
                        ...
                        return (
                            ...
                            res
                                .then(function () {
                                    return (
                                        (block.physicId = _this8.sheetPhysics.addObject(
                                            mass,
                                            angle,
                                            velocity,
                                            flexibility,
                                            ...
                                            function (angl, ch) {
                                                if (
                                                    ...
                                                    !_this8.sheetPhysics.getSize())
                                                ) {
                                                    var p = _this8.getPage();
                                                    (0 !== p && p !== _this8.getPages() - 1) ||
                                                        _this8.reducePagesWidth(!0);
                                                }
                                                Promise.resolve().then(function () {
                                                    _this8.sheetPhysics.getSize() ||
                                                        (_this8.notifyAfterAnimation(), _this8.calculateShadow());
                                                }),
                                                    _this8.updateThree();
                                            },
                                            function (object, angle, velocity, cornerHeight) {
                                                return _this8.calcBlockForce(
                                                    block,
                                                    object,
                                                    angle,
                                                    velocity,
                                            ...
                                            function (object, angle, velocity, cornerHeight) {
                                                return _this8.calcBlockCornerForce(
                                                    block,
                                                    object,
                                                    angle,
                                                    velocity,
                                        ...
                                        1 === _this8.sheetPhysics.getSize() && _this8.reducePagesWidth(!1),
                                        block
                                    );
                                })
                                .catch(function () {})
                    ...
                    (Book.prototype.update = function (dt) {
                        ...
                        (this.lastMousePos.t += dt),
                            this.isProcessing() &&
                                ...
                                Promise.resolve().then(function () {
                                    (0, _libs.$)(_this9.visual.element).trigger(
                                        _libs.$.Event("mousemove", _this9.lastMousePos)
                                    );
                                })),
                    ...
                    (Book.prototype.cssLayersLoader = function (loader) {
                        ...
                        return function (n, clb) {
                            ...
                            return n >= 0 && nn < _this10.getPages()
                                ? loader(nn, function (ls) {
                                      for (
                                          var nls = [],
                                              _iterator10 = ls,
                                          ...
                                          var l = _ref10;
                                          nls.push(_extends({}, l, { js: _this10.cssLayerJsObject(l) }));
                                      }
                                      return clb(nls);
                                  })
                                : clb([]);
                    ...
                    (Book.prototype.cssLayerJsObjectInit = function (c, p) {
                        ...
                        c.find(".go-to-page").on("click", function (e) {
                            for (var n = (0, _libs.$)(e.target); n.length && !n.hasClass("go-to-page"); )
                        ...
                        return {
                            hide: function () {
                                _this12.pendingPlayers.length &&
                                    ((_this12.pendingPlayers = []), _this12.dispatchEvent({ type: "pendingPlayers" })),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _typeof =
            ...
            _EventsToActions = __webpack_require__(53),
            _EventsToActions2 = _interopRequireDefault(_EventsToActions),
            _stats = __webpack_require__(76),
            _stats2 = _interopRequireDefault(_stats),
            _Object3DWatcher = __webpack_require__(59),
            ...
            BookController = (function (_Controller) {
                    ...
                    return (
                        (_this.bookWatcher = new _Object3DWatcher2.default(_this.visual, function () {
                            if (_this.state.singlePage)
                                ...
                                (box0.min.x = x0 - 0.5 * width), (box0.max.x = x0 + 0.5 * width);
                            }
                            return box0;
                        })),
                ...
                return (
                    ...
                    (BookController.prototype.setEmbeddedInline = function (embeddedInline) {
                                ...
                                if (_this4.pendingAutoPlay === pendingAutoPlay && _this4.state.autoPlay) {
                                    if (!_this4.book.isProcessing()) {
                                        ...
                                        _this4.p.rtl
                                            ...
                                            : (flipped = _this4.canFlipRight()) && _this4.cmdForward(),
                                            flipped || _this4._goToPage(0);
                                    }
                                    _this4.autoPlay();
                                }
                    ...
                    (BookController.prototype.cmdSearchBtn = function () {
                        this.tocCtrl &&
                            (this.tocCtrl.visible
                                ? "search" === this.tocCtrl.tab
                                    ? this.tocCtrl.togle()
                                    : this.tocCtrl.cmdSearch()
                                : (this.tocCtrl.togle(), this.tocCtrl.cmdSearch()));
                    }),
                    ...
                    (BookController.prototype.cmdSave = function () {
                        var a = (0, _libs.$)(
                            '<a href="' + this.p.downloadURL + '" download target="_blank"></a>'
                    ...
                    (BookController.prototype.isSinglePageAvailable = function () {
                        return 2 !== this.book.getRealPages() || "half" === this.book.p.singlePageMode;
                    }),
                    (BookController.prototype.cmdSinglePage = function () {
                        if (this.isSinglePageAvailable()) {
                            if ("full" === this.book.p.singlePageMode)
                                (this.state.singlePage = !this.state.singlePage),
                                    this.setBookZoom(this.bookWatcher.scale),
                                    this.updateView();
                            else {
                                var page = this.getPageForGUI() - 1;
                                this.book.togleHalfBookMode(), this.updateView(), this.goToPage(page);
                            }
                            this.dispatchAsync({
                                type: "pageMode",
                    ...
                    (BookController.prototype.goToPage = function (page) {
                        return this._goToPage(this.book.isHalfBookMode() ? 2 * page : page);
                    }),
                    (BookController.prototype._goToPage = function (page) {
                        var _this7 = this;
                        ...
                        if (target != current) {
                            0 === current
                                ...
                                : current === this.book.getBookPages() - 1 && (flips.push(-1), (current -= 2), ++covs);
                            var cv = 0;
                            0 === target
                                ? ((cv = -1), (target += 1), ++covs)
                                : target === this.book.getBookPages() - 1 && ((cv = 1), (target -= 2), ++covs),
                    ...
                    (BookController.prototype.startFlip = function (flipRes) {
                        ...
                        return flipRes
                            ? flipRes.then(function (block) {
                                  return block && _this8.dispatchAsync({ type: "startFlip" }), block;
                              })
                    ...
                    (BookController.prototype.getPageForGUI = function () {
                        ...
                        return (
                            ...
                            this.book.isHalfBookMode() ? (this.p.rtl ? (n + 1) / 2 : (n - (n % 2)) / 2 + 1) : n
                        );
                    }),
                    ...
                    (BookController.prototype.updateViewState = function () {
                        this.viewState = {
                            ...
                            cmdSearchBtn: {
                                ...
                                active: this.tocCtrl && this.tocCtrl.visible && "search" === this.tocCtrl.tab,
                            },
                            inpPages: { visible: !0, value: this.book.getRealPages() },
                            inpPage: {
                                visible: !0,
                            ...
                            widToolbar: { enable: !0, visible: this.isCmdVisible("widToolbar"), active: !1 },
                            cmdSmartPan: {
                                enable: !0,
                        ...
                        return _extends({}, cmds, {
                            ...
                            mouseCmdWheelZoom: {
                                activate: function (e) {
                                    ...
                                    (!_this9.embeddedInline ||
                                        (_FullScreenX2.default.available() && _FullScreenX2.default.activated())) &&
                                        (e.deltaY < 0 ? _this9.cmdZoomOut() : e.deltaY > 0 && _this9.cmdZoomIn()),
                                        (!_this9.state.smartPan || Math.abs(_this9.bookWatcher.scale - scale) > 1e-4) &&
                                            e.preventDefault();
                                },
                            },
                            touchCmdRotate: {
                            ...
                            touchCmdZoom: {
                                activate: function (e, data) {
                                    if (!isSwipping("touchCmdZoom")) {
                                        ...
                                        "start" === data.state
                                            ? (_this9.touchZoomData = { l: l(data), scale: _this9.bookWatcher.scale })
                                            : "move" === data.state &&
                                              (e.preventDefault(),
                                              _this9.setScale(
                                        ...
                                        if ("start" === data.state) {
                                            ...
                                            "move" === data.state
                                                ? _this9.swipeData.handled ||
                                                  ...
                                                  Math.abs(_this9.swipeData.x0 - _this9.swipeData.x) > 100 &&
                ...
                return (
                                    ...
                                    callManually
                                        ...
                                        : ((this.loading = !0),
                                          ...
                                          (0, _libs.$)(this.frame).on("load", function () {
                                              setTimeout(function () {
                                                  delete _this2.loading, _this2.dispatchEvent({ type: "loaded" });
                                                  try {
                                                      printWnd.print();
                                                  } catch (e) {
                                                      console.error(e);
                    ...
                    (BookPrinter.prototype.renderContent = function () {
                            ...
                            !(function (page) {
                                ...
                                "image" === info.type
                                    ? (done = done.then(function () {
                                          return (
                                              _this3.progress(page / pages), _this3.renderImage(head, body, info.src)
                                          );
                                      }))
                                    : "html" === info.type &&
                                      (done = done.then(function () {
                        ...
                        return done.then(function () {
                            return _this3.progress(1), { head: _this3.renderHead(head), body: body.join("\n") };
                        });
                    }),
    ...
    function (module, exports, __webpack_require__) {
        ...
        exports.__esModule = !0;
        var _View2 = (__webpack_require__(1), __webpack_require__(70)),
            _View3 = (function (obj) {
                return obj && obj.__esModule ? obj : { default: obj };
            })(_View2),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _extends =
            ...
            _Cache2 = _interopRequireDefault(_Cache),
            _LoadingAnimation = __webpack_require__(56),
            _LoadingAnimation2 = _interopRequireDefault(_LoadingAnimation),
            _ImageFactory = __webpack_require__(8),
            _ImageFactory2 = _interopRequireDefault(_ImageFactory),
            _TextureAnimator = __webpack_require__(64),
            ...
            PageManager = (function () {
                function PageManager(visual, book, p) {
                    ...
                    for (var i = 0; i < 10; ++i) {
                        ...
                        this.canvases.push({
                            c: c,
                            ctx: c.getContext("2d", { willReadFrequently: !0, desynchronized: !1 }),
                        });
                    }
                    (this.nextCanvas = 0),
                        ...
                        (this.tmpMaterialMesh = new _libs.THREE.Mesh(
                ...
                return (
                    (PageManager.prototype.createLoadingTexture = function (p) {
                        var heightTexels = (p.height / p.width) * p.widthTexels,
                            ...
                            animator = new _TextureAnimator2.default(animation.createSprite(6), 6, 1, 6, 0.2);
                    ...
                    (PageManager.prototype.refreshPageQuery = function (n) {
                        ...
                        object &&
                            ...
                            (this.pageCache.remove(n) ||
                                (object.wrapper.setQuery(query), this.pushInRenderQueue(object)));
                    }),
                        ...
                        if (this.p.autoResolution.enabled) {
                            ...
                            this.pageCache.forEach(function (e) {
                                ...
                                es.forEach(function (e) {
                                    ...
                                    object &&
                                        object.wrapper &&
                                        (_this.pageCache.remove(e[0]) || _this.pushInRenderQueue(object));
                                });
                        }
                    }),
                    ...
                    (PageManager.prototype.matchImageToPage = function (image, pageN) {
                        ...
                        return (
                            !p.stretchImages &&
                                Math.abs(bookK - image.width / image.height) / bookK > 0.03 &&
                                (bookH < image.height
                                    ? ((imageW = Math.ceil((image.width * bookH) / image.height)), (imageH = bookH))
                                    : (imageH = image.height)),
                            {
                                x: (bookW - imageW) / 2,
                                y: (bookH - imageH) / 2,
                    ...
                    (PageManager.prototype.imageToPageTexture = function (o, n, image) {
                        if (
                            ((o.match = o.match || this.matchImageToPage(image, n)),
                            o.match.width !== o.match.pageWidth || o.match.height !== o.match.pageHeight)
                        ) {
                    ...
                    (PageManager.prototype.load = function (material, n) {
                        var _this3 = this,
                            ...
                            o = {
                                ...
                                locked: function (n) {
                                    return (
                                        "loading" === o.state || "rendering" === o.state || _this3.book.isActivePage(n)
                                    );
                                },
                                color: p.color,
                                isActive: function () {
                    ...
                    (PageManager.prototype.calcResolution = function (o) {
                        ...
                        if (this.p.autoResolution.enabled) {
                            var k =
                                ...
                                Math.min(
                                    ((this.isSinglePage(o) || this.book.isHalfBookMode() ? 1 : 0.5) *
                                        this.visual.width()) /
                                        o.widthTexels,
                            ...
                            res.width < minRes &&
                                (res = { width: minRes, height: (minRes * o.heightTexels) / o.widthTexels }),
                                res.height < minRes &&
                                    (res = { width: (minRes * o.widthTexels) / o.heightTexels, height: minRes }),
                                res.width > maxRes &&
                                    (res = { width: maxRes, height: (maxRes * o.heightTexels) / o.widthTexels }),
                                res.height > maxRes &&
                                    (res = { width: (maxRes * o.widthTexels) / o.heightTexels, height: maxRes });
                    ...
                    (PageManager.prototype.getFreeCanvas = function () {
                        var c = this.canvases[this.nextCanvas];
                        return (this.nextCanvas = (this.nextCanvas + 1) % this.canvases.length), c;
                    }),
                                ...
                                if (this.rendering)
                                    if (this.rendering.wrapper && this.rendering.wrapper.startRender) {
                                        ...
                                        this.rendering.wrapper.setRenderCanvas(_o.c, _o.ctx),
                                            ...
                                            this.book.dispatchEvent({ type: "startRendering", page: _o.n });
                    ...
                    (PageManager.prototype.turnOffEvents = function () {
                        ...
                        this.pageCache.forEach(function (ent) {
                            var object = ent[1];
                            object.simulate &&
                                (object.simulate(mouseup, void 0, 0, 0), object.simulate(mouseout, void 0, 0, 0));
                        }),
                                ...
                                this.pageCache.forEach(function (ent) {
                                    ...
                                    if (o.simulate)
                                        if (
                                            toObject !== o ||
                                            !o.match ||
                                            (o.match.width === o.match.pageWidth &&
                                                o.match.height === o.match.pageHeight)
                                        )
                                            ...
                                            x > o.match.x &&
                                            x < o.match.x + o.match.width &&
                                            y > o.match.y &&
                                            y < o.match.y + o.match.height
                                                ? o.simulate(
                                                      e,
                                                      toDoc,
                                                      (x - o.match.x) / o.match.width,
                                                      1 - (y - o.match.y) / o.match.height
                                                  )
                ...
                return (
                    ...
                    (PdfLinksHandler.prototype.defaultHandler = function (type, destination) {
                        "internal" === type
                            ...
                            : "external" === type &&
                              -1 === destination.toLowerCase().search("javascript:") &&
                ...
                return (
                    ...
                    (SearchEngine.prototype.process = function () {
                        ...
                        if (this.update) {
                            ...
                            if (((this.update = !1), (this.page = 0), (this.stamp = Date.now()), this.query.length > 1))
                                this.process();
                            else if (0 === this.query.length)
                                for (var page = 0; page < this.pages; ++page) this.onPageHitsChanged(page, this.query);
                        } else if (this.page < this.pages) {
                            var stamp = this.stamp;
                            this.find(this.pageCallback(this.page)).then(function (contexts) {
                                stamp === _this.stamp &&
                                    (contexts.length && _this.results.push({ page: _this.page, contexts: contexts }),
                ...
                return (
                    ...
                    (ShareController.prototype.clickLink = function (u) {
                        var blank = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                            a = (0, _libs.$)(
                                '<a href="' + u + '"' + (blank ? ' target="_blank"' : "") + "></a>"
                            ).appendTo(this.view.getContainer());
                        a[0].click(), a.remove();
                    }),
                    ...
                    (ShareController.prototype.updateView = function () {
                        if (this.view) {
                            for (
                                var _arr = ["cmdCloseShare", "cmdFacebook", "cmdTwitter", "cmdEmail"], _i = 0;
                                _i < _arr.length;
                                _i++
                            ) {
                                var cmd = _arr[_i];
                            ...
                            this.view.setState("txtShareLink", { value: this.getLink(), visible: !0 }),
            ...
            SheetPhysics = (function () {
                ...
                return (
                        ...
                        for (
                            ...
                            o.simulateClb && o.simulateClb(o.l / this.p.r, o.ch),
                                (o.l !== this.p.l && 0 !== o.l) || 0 !== o.v
                                    ? nos.push(o)
                                    : void 0 !== o.removeClb && notify[(o.l !== this.p.l) + 0].push(o);
                        }
                        this.os = nos;
                        for (
                    ...
                    (SheetPhysics.prototype.findAndSolveCornerCollisions = function () {
                        if (this.os.length)
                            for (
                                var os = [_extends({}, this.os[0], { l: 0, m: this.p.infM, ch: 0 })].concat(this.os, [
                                        _extends({}, this.os[0], { l: 1.05 * this.p.l, m: this.p.infM, ch: 0 }),
                                    ]),
                                    i = 1;
                                i < os.length;
                                ++i
        ...
        var SoundsEnviroment = (function () {
            function SoundsEnviroment() {
                ...
                _classCallCheck(this, SoundsEnviroment),
                    ...
                    this.sounds.endFlip &&
                        ((this.audio.endFlip = new Audio(this.sounds.endFlip)), (this.audio.endFlip.volume = 0.5));
            }
            return (
                ...
                (SoundsEnviroment.prototype.endFlip = function () {
                    this.enabled &&
                        ...
                        (this.audio.startFlip.pause(), (this.audio.startFlip.currentTime = 0)),
            ...
            TocController = (function (_WidgetController) {
                ...
                return (
                    ...
                    (TocController.prototype.openUrl = function (url) {
                        -1 === url.toLowerCase().search("javascript:") && window.open(url, "_blank");
                    }),
    ...
    function (module, exports, __webpack_require__) {
        ...
        addFaces(topGeometry.faces, function (i) {
            ...
            (exports.default = { resX: 11, resY: 2, resZ: 15, faces: faces, geometry: geometry });
    },
    function (module, exports, __webpack_require__) {
        "use strict";
        function props() {
            return {
                ...
                actions: {
                    ...
                    cmdDefaultZoom: { enabled: !1, enabledInNarrow: !1, type: "dblclick", code: 0 },
                    cmdToc: { enabled: !0, enabledInNarrow: !0, active: !1, defaultTab: "bookmarks" },
                    ...
                    cmdSearchBtn: { enabled: !0, enabledInNarrow: !0 },
    ...
    function (module, exports, __webpack_require__) {
            ...
            var scene = {
                dispose: function () {
                    scene.ready
                        ...
                        : (scene.pendingDispose = !0);
                },
            };
            return (
                (options = _extends({}, options)),
                options.activateFullScreen && _FullScreenX2.default.request(parentContainer),
                                ...
                                (scene.bookBuilder = function (props, sheets, pageCallback) {
                                    ...
                                    (scene.shareCtrl = new _ShareController2.default(
                                        ...
                                        options.shareLinkBuilder
                                            ? options.shareLinkBuilder
                                            : function (page) {
                                                  return new RegExp("([?&])" + autoNavigator.urlParam + "=[0-9]+").test(
                                                      location.href
                                                  )
        ...
        var _libs = __webpack_require__(1),
            _Detector = __webpack_require__(49),
            _Detector2 = _interopRequireDefault(_Detector),
            _VisualWorld = __webpack_require__(71),
                                            ...
                                            ? ((node.minimized = !node.minimized),
                                              node.minimized
                                                  ...
                                                  : (li.find(".togle").removeClass("minimized"),
                                                    li.append(
                                                        (_this.renderNode(node).match(/<ul(.|\n)*<\/ul>/g) || [""])[0]
                                                    )))
        ...
        var Dom2Image = function Dom2Image(wnd, doc, cache) {
            ...
            function embedFonts(node) {
                return fontFaces.resolveAll().then(function (cssText) {
                    ...
                    return (
                        node.appendChild(styleNode), styleNode.appendChild(self.document.createTextNode(cssText)), node
                    );
                });
            }
                            ...
                            return function () {
                                return (
                                    ...
                                    (function () {
                                        return (
                                            "0000" +
                                            ((self.window.Math.random() * self.window.Math.pow(36, 4)) << 0).toString(
                                                36
                                            )
                                        ).slice(-4);
                                    })() +
            ...
            (this.toSvg = toSvg),
                ...
                (this.impl = { fontFaces: fontFaces, images: images, util: util, inliner: inliner });
        };
                        ...
                        this.enabled &&
                            ...
                            this.selected &&
                                ...
                                this.raycaster.ray.intersectPlane(this.plane, this.intersection) &&
                                    (this.onDragCallback(this.intersection) || this.onMouseUp(e))));
                    }),
        ...
        var EventsToActions = (function () {
            ...
            return (
                ...
                (EventsToActions.getPosition = function (touches) {
                    ...
                    return (
                        2 === touches.length
                            ? ((x = touches[1].pageX - touches[0].pageX), (y = touches[1].pageY - touches[0].pageY))
                ...
                (EventsToActions.prototype.touchMove = function (e) {
                    if (this.enabled) {
                        var flags = EventsToActions.getEventFlags(e),
                            touches = e.touches || e.originalEvent.touches;
                        if (
                            (this.fireActions(this.getActions("touchmove", touches.length, flags), e), this.touchPicked)
                        )
                ...
                (EventsToActions.prototype.touchEnd = function (e) {
                    this.touchPicked &&
                        (this.fireActions(this.touchPicked.actions, e, { state: "end" }), delete this.touchPicked);
                }),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _libs = __webpack_require__(0),
            ...
            _Dom2Image = __webpack_require__(51),
            _Dom2Image2 = _interopRequireDefault(_Dom2Image),
            _DocMouseSimulator = __webpack_require__(50),
                ...
                return (
                    ...
                    (InteractiveImage.prototype.render = function () {
                        ...
                        this.svgRender
                            ...
                            : (0, _libs.html2canvas)(this.frame.contentDocument.body, { timeout: 3e4 }).then(
                                  function (canvas) {
            ...
            LoadingAnimation = (function () {
                function LoadingAnimation(width, height, color) {
                    _classCallCheck(this, LoadingAnimation),
                        ...
                        (this.p = { g: 9.8, dt: 1 / 60, color: color, updateInterval: 0.25 }),
                ...
                return (
                    ...
                    (LoadingAnimation.prototype.update = function (T) {
                        if (((this.os = this.integrate(T)), (this.t += T), this.t >= this.p.updateInterval)) {
                            ...
                            for (var i = 0, _a = a, _r = 0.2 * r; i < 10; ++i, _r *= 0.9, _a += da) {
                                ctx.beginPath(),
                                    (ctx.fillStyle = _GraphUtils2.default.color2Rgba(
                                        _GraphUtils2.default.inverseColor(this.p.color, (10 - i) / 10),
                                        (0.7 * (10 - i)) / 10
                                    ));
            ...
            (function () {
                ...
                return (
                    (LoadingController.defaultLoadingMsg = function (progress) {
                        return ["PDF is Loading...: ", progress, "%"].join("");
                    }),
                    ...
                    (LoadingController.prototype.updateView = function () {
                        if (this.view) {
                            ...
                            this.view.setState("inpPages", { visible: !0, value: "" }),
                                this.view.setState("inpPage", { visible: !0, enable: !1, value: "" });
                        }
                    }),
                    LoadingController
                );
            ...
            Object3DWatcher = (function () {
                ...
                return (
                    ...
                    (Object3DWatcher.prototype.centerView = function (T) {
                        ...
                        if (
                            Math.sqrt(this.os.vx * this.os.vx + this.os.vy * this.os.vy) > 0.003 ||
                            dv.length() > 0.003
                        ) {
                            var dt = 1 / 60,
                                t = 0,
                    ...
                    (Object3DWatcher.prototype.integrate = function (os, dt) {
                        var _MathUtils$rk = _MathUtils2.default.rk4(this.dy.bind(os), 0, dt, [
                                os.vx,
                                os.vy,
                                os.x,
                                os.y,
                ...
                function Orbit(object, world) {
                    ...
                    function offsetDolly(event, data) {
                        scope.enabled &&
                            scope.enableZoom &&
                            "move" === data.state &&
                            (data.dy > 0 ? dollyIn(getZoomScale()) : data.dy < 0 && dollyOut(getZoomScale()),
                            scope.update());
                    }
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _libs = __webpack_require__(0),
            ...
            _CustomEventConverter = __webpack_require__(16),
            _CustomEventConverter2 = _interopRequireDefault(_CustomEventConverter),
            _PolyTarget = __webpack_require__(74),
            ...
            Search = (function () {
                function Search(container, pages) {
                    _classCallCheck(this, Search),
                        ...
                        (this.prevResults = []),
                        container.html(
                            '\n      <div class="search">\n        <div class="query">\n          <input class="inpQuery" placeholder="' +
                                (0, _libs.tr)("Search") +
                        ...
                        if (this.onQuery) {
                            ...
                            setTimeout(function () {
                                queryStamp === _this.queryStamp &&
                                    ((_this.lastQuery = _this.query[0].value.trim()), _this.onQuery(_this.lastQuery));
                            }, 1e3);
                        }
                    }),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _libs = __webpack_require__(0),
            _Utils = __webpack_require__(2),
            _Utils2 = _interopRequireDefault(_Utils),
            _MouseEventConverter2 = __webpack_require__(58),
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _libs = __webpack_require__(0),
            _Utils = __webpack_require__(2),
            _Utils2 = _interopRequireDefault(_Utils),
            _TouchEventConverter2 = __webpack_require__(68),
                ...
                function View(parentContainer, onLoad) {
                    ...
                    var build = function build() {
                        ...
                        "function" == typeof template
                            ? ((urls = {}), (files = template()), (links = []), (templateName = files.name))
                    ...
                    (0, _libs.$)(this.frame).on("load", build), (this.frame.src = "");
                }
                return (
                        ...
                        (this.pendings[id] = { timestamp: new Date().getTime() }),
                            setTimeout(function () {
                                ...
                                pending &&
                                    ...
                                    (View.callHandlers(handlers, id, e, data), delete _this.pendings[id]);
                            }, ms);
                    }),
                    ...
                    (View.prototype.urlResolver = function (baseUrl, url) {
                        if (
                            ((url = url.replace(/\\/g, "/")),
                            "/" === url.charAt(0) && ((baseUrl = this.getRootUrl()), (url = url.substr(1))),
                ...
                function VisualWorld(wnd, doc, container) {
                    ...
                    (_this.light.castShadow = !0),
                        ...
                        (_this.shadowPlace = new _libs.THREE.Mesh(
                            ...
                            new _libs.THREE.ShadowMaterial({ color: 0, transparent: !0, opacity: 0.2 })
                        )),
                ...
                return (
                    u(0),
                    {
                        ...
                        begin: function () {
                            ...
                            if (
                                (h.update(c - k, 200),
                                c > g + 1e3 && (r.update((1e3 * a) / (c - g), 100), (g = c), (a = 0), t))
                            ) {
