...
<table  cellspacing="5">
	...
	<tr>
		<th>
			<label for="pdfdownload_file"><?php _e( 'Add PDF URL', TEXTDOMAIN )?></label>
		</th>
		<td>
			...
			<button type="button" class="button" id="events_video_upload_btn" data-media-uploader-target="#pdfdownload_file"><?php _e( 'Upload', TEXTDOMAIN )?></button>
		</td>
	</tr>
</table>
