<?php
/**
 * Plugin Name: 3D Flipbook PDF Viewer & Embedder
...
if( ! class_exists( 'PDFEV_Embed_Viewer' ) ){
    class PDFEV_Embed_Viewer{
        ...
        public function define_contstants(){
            ...
            define( 'PDFEV_Const_VERSION', '1.5.1' );
        }
        ...
        public static function include_plugin_files() {
            ...
            require_once PDFEV_Const_Path . 'classes/metabox/book-info.php';
        ...
        public static function activate(){
            ...
            if ( ! get_option('pdfev_dummy_import_done') ) {
