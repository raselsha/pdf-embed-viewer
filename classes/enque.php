...
if( ! class_exists('SH_PDF_Embed_Viewer_Enque') ){
    class SH_PDF_Embed_Viewer_Enque{
        ...
        public function backend_style(){
            ...
            wp_register_script( 'script', SH_PDF_EMBED_VIEWER.'assets/js/script.js', ['jquery-ui']);
            wp_enqueue_script( 'script' );
            wp_register_script( 'jquery-ui', 'https://code.jquery.com/ui/1.12.1/jquery-ui.js', []);
            wp_enqueue_script( 'jquery-ui' );

            wp_enqueue_style( 'wp-color-picker' ); 
            wp_enqueue_script( 'pdf-download', SH_PDF_EMBED_VIEWER.'assets/js/script.js', array( 'wp-color-picker' ), false, true ); 
        }
    }
